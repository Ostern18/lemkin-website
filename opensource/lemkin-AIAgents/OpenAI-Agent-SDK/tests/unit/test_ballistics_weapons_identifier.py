...
class TestBallisticsWeaponsIdentifierSpecificFunctionality:
    ...
    @patch('agents.Agent')
    def test_weapon_identification(self, mock_openai, shared_infrastructure, mock_openai_response):
    ...
    @patch('agents.Agent')
    def test_ballistic_pattern_analysis(self, mock_openai, shared_infrastructure, mock_openai_response):
    ...
    @patch('agents.Agent')
    def test_munition_classification(self, mock_openai, shared_infrastructure, mock_openai_response):
