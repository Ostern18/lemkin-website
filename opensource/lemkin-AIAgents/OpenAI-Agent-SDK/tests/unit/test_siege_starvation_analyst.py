...
class TestSiegeStarvationAnalystSpecificFunctionality:
    ...
    @patch('agents.Agent')
    def test_siege_pattern_detection(self, mock_openai, shared_infrastructure, mock_openai_response):
    ...
    @patch('agents.Agent')
    def test_humanitarian_impact_assessment(self, mock_openai, shared_infrastructure, mock_openai_response):
    ...
    @patch('agents.Agent')
    def test_civilian_targeting_analysis(self, mock_openai, shared_infrastructure, mock_openai_response):
