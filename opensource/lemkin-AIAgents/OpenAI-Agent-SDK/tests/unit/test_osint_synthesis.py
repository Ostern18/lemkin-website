...
class TestOSINTSynthesisSpecificFunctionality:
    ...
    @patch('agents.Agent')
    def test_source_verification(self, mock_openai, shared_infrastructure, mock_openai_response):
    ...
    @patch('agents.Agent')
    def test_multi_source_analysis(self, mock_openai, shared_infrastructure, mock_openai_response):
    ...
    @patch('agents.Agent')
    def test_credibility_assessment(self, mock_openai, shared_infrastructure, mock_openai_response):
