...
class TestSatelliteImageryAnalystSpecificFunctionality:
    ...
    @patch('agents.Agent')
    def test_image_processing(self, mock_openai, shared_infrastructure, mock_openai_response):
    ...
    @patch('agents.Agent')
    def test_geospatial_analysis(self, mock_openai, shared_infrastructure, mock_openai_response):
    ...
    @patch('agents.Agent')
    def test_change_detection(self, mock_openai, shared_infrastructure, mock_openai_response):
