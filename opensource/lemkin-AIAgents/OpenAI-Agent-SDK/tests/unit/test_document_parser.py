...
class TestDocumentParserSpecificFunctionality:
    ...
    @patch('agents.Agent')
    def test_pdf_processing(self, mock_openai, shared_infrastructure, mock_openai_response):
    ...
    @patch('agents.Agent')
    def test_text_extraction(self, mock_openai, shared_infrastructure, mock_openai_response):
