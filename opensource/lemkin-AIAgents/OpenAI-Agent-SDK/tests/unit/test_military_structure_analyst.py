...
class TestMilitaryStructureAnalystSpecificFunctionality:
    ...
    @patch('agents.Agent')
    def test_command_chain_mapping(self, mock_openai, shared_infrastructure, mock_openai_response):
    ...
    @patch('agents.Agent')
    def test_unit_identification(self, mock_openai, shared_infrastructure, mock_openai_response):
    ...
    @patch('agents.Agent')
    def test_responsibility_attribution(self, mock_openai, shared_infrastructure, mock_openai_response):
