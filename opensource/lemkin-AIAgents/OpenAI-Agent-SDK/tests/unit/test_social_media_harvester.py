...
class TestSocialMediaHarvesterSpecificFunctionality:
    ...
    @patch('agents.Agent')
    def test_metadata_preservation(self, mock_openai, shared_infrastructure, mock_openai_response):
    ...
    @patch('agents.Agent')
    def test_authenticity_verification(self, mock_openai, shared_infrastructure, mock_openai_response):
    ...
    @patch('agents.Agent')
    def test_digital_chain_of_custody(self, mock_openai, shared_infrastructure, mock_openai_response):
