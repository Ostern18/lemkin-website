...
class TestGenocideIntentAnalyzerSpecificFunctionality:
    ...
    @patch('agents.Agent')
    def test_intent_indicators(self, mock_openai, shared_infrastructure, mock_openai_response):
    ...
    @patch('agents.Agent')
    def test_systematic_pattern_detection(self, mock_openai, shared_infrastructure, mock_openai_response):
    ...
    @patch('agents.Agent')
    def test_genocide_convention_analysis(self, mock_openai, shared_infrastructure, mock_openai_response):
