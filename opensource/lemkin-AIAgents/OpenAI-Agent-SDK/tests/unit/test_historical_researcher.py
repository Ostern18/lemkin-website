...
class TestHistoricalResearcherSpecificFunctionality:
    ...
    @patch('agents.Agent')
    def test_context_retrieval(self, mock_openai, shared_infrastructure, mock_openai_response):
    ...
    @patch('agents.Agent')
    def test_timeline_generation(self, mock_openai, shared_infrastructure, mock_openai_response):
    ...
    @patch('agents.Agent')
    def test_source_citation(self, mock_openai, shared_infrastructure, mock_openai_response):
