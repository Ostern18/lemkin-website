...
class TestComparativeAnalyzerSpecificFunctionality:
    ...
    @patch('agents.Agent')
    def test_multi_document_comparison(self, mock_openai, shared_infrastructure, mock_openai_response):
    ...
    @patch('agents.Agent')
    def test_contradiction_detection(self, mock_openai, shared_infrastructure, mock_openai_response):
    ...
    @patch('agents.Agent')
    def test_consistency_analysis(self, mock_openai, shared_infrastructure, mock_openai_response):
