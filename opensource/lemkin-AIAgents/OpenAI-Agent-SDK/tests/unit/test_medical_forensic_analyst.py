...
class TestMedicalForensicAnalystSpecificFunctionality:
    ...
    @patch('agents.Agent')
    def test_istanbul_protocol_indicators(self, mock_openai, shared_infrastructure, mock_openai_response):
    ...
    @patch('agents.Agent')
    def test_injury_pattern_analysis(self, mock_openai, shared_infrastructure, mock_openai_response):
    ...
    @patch('agents.Agent')
    def test_torture_indicator_detection(self, mock_openai, shared_infrastructure, mock_openai_response):
