"""
NGO & UN Reporting Specialist Agent (OpenAI Agents SDK Implementation)
...
from .config import ReporterConfig, DEFAULT_CONFIG


class NGOUNReporterAgent:
    """
    Agent for NGO and UN reporting.
    ...
    def __init__(
        ...
        **kwargs
        ...
        """
        Initialize NGO & UN Reporting Specialist.
