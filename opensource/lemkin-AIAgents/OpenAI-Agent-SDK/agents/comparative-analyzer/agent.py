"""
Comparative Document Analyzer Agent (OpenAI Agents SDK Implementation)
...
from .config import ComparativeConfig, DEFAULT_CONFIG


class ComparativeAnalyzerAgent:
    """
    Agent for comparative analysis across documents.
    ...
    def __init__(
        self,
        config: Optional[ComparativeConfig] = None,
        audit_logger: Optional[AuditLogger] = None,
        evidence_handler: Optional[EvidenceHandler] = None,
        **kwargs
    ):
        """
        Initialize Comparative Document Analyzer.
