"""
Digital Forensics & Metadata Analyst Agent (OpenAI Agents SDK Implementation)
...
from .config import DigitalConfig, DEFAULT_CONFIG


class DigitalForensicsAnalystAgent:
    """
    ...
    def __init__(
        self,
        config: Optional[DigitalConfig] = None,
        audit_logger: Optional[AuditLogger] = None,
        evidence_handler: Optional[EvidenceHandler] = None,
        **kwargs
    ):
        """
        Initialize Digital Forensics & Metadata Analyst.
