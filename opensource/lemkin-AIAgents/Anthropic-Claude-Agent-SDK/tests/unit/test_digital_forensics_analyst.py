...
class TestDigitalForensicsAnalystSpecificFunctionality:
    ...
    @patch('anthropic.Anthropic')
    def test_digital_signature_verification(self, mock_anthropic, shared_infrastructure, mock_claude_response):
    ...
    @patch('anthropic.Anthropic')
    def test_timestamp_validation(self, mock_anthropic, shared_infrastructure, mock_claude_response):
