...
class TestLegalAdvisorSpecificFunctionality:
    ...
    @patch('anthropic.Anthropic')
    def test_jurisdiction_analysis(self, mock_anthropic, shared_infrastructure, mock_claude_response):
    ...
    @patch('anthropic.Anthropic')
    def test_applicable_law_identification(self, mock_anthropic, shared_infrastructure, mock_claude_response):
    ...
    @patch('anthropic.Anthropic')
    def test_precedent_citation(self, mock_anthropic, shared_infrastructure, mock_claude_response):
