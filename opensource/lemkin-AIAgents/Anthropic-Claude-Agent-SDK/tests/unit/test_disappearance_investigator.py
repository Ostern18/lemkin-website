...
class TestDisappearanceInvestigatorSpecificFunctionality:
    ...
    @patch('anthropic.Anthropic')
    def test_disappearance_pattern_analysis(self, mock_anthropic, shared_infrastructure, mock_claude_response):
    ...
    @patch('anthropic.Anthropic')
    def test_last_known_location_tracking(self, mock_anthropic, shared_infrastructure, mock_claude_response):
    ...
    @patch('anthropic.Anthropic')
    def test_witness_statement_correlation(self, mock_anthropic, shared_infrastructure, mock_claude_response):
