...
class TestNGOUNReporterSpecificFunctionality:
    ...
    @patch('anthropic.Anthropic')
    def test_report_formatting(self, mock_anthropic, shared_infrastructure, mock_claude_response):
    ...
    @patch('anthropic.Anthropic')
    def test_un_standards_compliance(self, mock_anthropic, shared_infrastructure, mock_claude_response):
    ...
    @patch('anthropic.Anthropic')
    def test_citation_verification(self, mock_anthropic, shared_infrastructure, mock_claude_response):
