...
class TestTortureAnalystSpecificFunctionality:
    ...
    @patch('anthropic.Anthropic')
    def test_torture_method_identification(self, mock_anthropic, shared_infrastructure, mock_claude_response):
    ...
    @patch('anthropic.Anthropic')
    def test_istanbul_protocol_compliance(self, mock_anthropic, shared_infrastructure, mock_claude_response):
    ...
    @patch('anthropic.Anthropic')
    def test_pattern_recognition(self, mock_anthropic, shared_infrastructure, mock_claude_response):
