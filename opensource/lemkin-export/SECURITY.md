...
We provide security updates for the following versions of lemkin-export:
...
## Security Considerations for Data Export & Compliance Analysis

### Sensitive Data Export & Compliance Data

Data Export & Compliance files processed by lemkin-export may contain:
...
When using lemkin-export, please:
...
1. **Data Export & Compliance Enhancement**: Enhanced audio may reveal previously inaudible content that could be privacy-sensitive
...
4. **Metadata Extraction**: Data Export & Compliance metadata may contain personally identifiable information
...
### Data Export & Compliance-Specific Security Issues
- Data Export & Compliance file parsing vulnerabilities
...
For general questions about lemkin-export:
- **GitHub Issues**: https://github.com/lemkin-org/lemkin-export/issues
