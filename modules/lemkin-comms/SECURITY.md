...
We provide security updates for the following versions of lemkin-comms:
...
## Security Considerations for Communication Analysis Analysis

### Sensitive Communication Analysis Data

Communication Analysis files processed by lemkin-comms may contain:
...
When using lemkin-comms, please:
...
1. **Communication Analysis Enhancement**: Enhanced audio may reveal previously inaudible content that could be privacy-sensitive
...
4. **Metadata Extraction**: Communication Analysis metadata may contain personally identifiable information
...
### Communication Analysis-Specific Security Issues
- Communication Analysis file parsing vulnerabilities
...
For general questions about lemkin-comms:
- **GitHub Issues**: https://github.com/lemkin-org/lemkin-comms/issues
